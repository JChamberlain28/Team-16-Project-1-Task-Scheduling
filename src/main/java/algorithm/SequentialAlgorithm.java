...
This algorithm is not used in the final release but preserved. It is incompatible with changes to output
parsing due to not using PartialSchedule. It also is not integrated with the visualisation
 */
